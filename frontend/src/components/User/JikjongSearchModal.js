...
const JikjongSearchModal = (props) => {
        ...
        return axios.get(AuthUrls.JIKJONG_INFO, {
            ...
            .then(({data})=>{
                ...
                let options = results.map((values) => {
                    return ({
                        jikjong_mid_cd: values.jikjong_mid_cd.raw,
                        jikjong_mid_name: values.jikjong_mid_name.raw,
                    })
                });
    ...
    return (
        <>
            <div className="modal-header">전문분야 설정</div>
...
export default JikjongSearchModal;